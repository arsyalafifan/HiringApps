        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-primary text-white text-sm">
              <th className="text-left px-4 py-3">Nama Sekolah / Universitas</th>
              <th className="text-left px-4 py-3">Date</th>
              <th className="text-left px-4 py-3">Fakultas</th>
              <th className="text-left px-4 py-3">Pendidikan</th>
